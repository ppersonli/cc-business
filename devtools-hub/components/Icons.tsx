export function JsonIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M4 6c0 1.1-.9 2-2 2s-2 .9-2 2 .9 2 2 2 2 .9 2 2" />
      <path d="M20 6c0 1.1.9 2 2 2s2 .9 2 2-.9 2-2 2-2 .9-2 2" />
      <path d="M4 6h4v12H8" />
...
export function RegexIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M9 17c0 1.1-.9 2-2 2s-2-.9-2-2 .9-2 2-2 2 .9 2 2z" />
      <path d="M17 17c0 1.1-.9 2-2 2s-2-.9-2-2 .9-2 2-2 2 .9 2 2z" />
      <path d="M4 17h3" />
      <path d="M14 17h3" />
    </svg>
  )
...
export function CssIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M8 8h8l-1 8-3 1-3-1-.5-4h3" />
    </svg>
  )
}
...
export function HtmlEncodeIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <polyline points="16 18 22 12 16 6" />
      <polyline points="8 6 2 12 8 18" />
...
export function MarkdownHtmlIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <rect x="2" y="4" width="20" height="16" rx="2" />
      <path d="M6 8v8" />
...
export function JsFormatterIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function BoxShadowIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <rect x="3" y="3" width="14" height="14" rx="2" />
      <path d="M7 17v4h14V7h-4" opacity="0.4" />
    </svg>
  )
}

export function JsonGoIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M4 6c0 1.1-.9 2-2 2s-2 .9-2 2 .9 2 2 2 2 .9 2 2" />
      <path d="M20 6c0 1.1.9 2 2 2s2 .9 2 2-.9 2-2 2-2 .9-2 2" />
...
export const iconMap: Record<string, React.FC> = {
  ...
  'unit-converter': UnitIcon,
  'color-picker': ColorPickerIcon,
  'markdown': MarkdownIcon,
  'css-minifier': CssIcon,
  'html-minifier': HtmlIcon,
  'diff-checker': DiffIcon,
  'json-schema-validator': SchemaIcon,
  'html-encoder': HtmlEncodeIcon,
  'markdown-to-html': MarkdownHtmlIcon,
  'ip-lookup': IpIcon,
  'api-tester': ApiIcon,
  'colors': ColorIcon,
  'color-palette': PaletteIcon,
  'js-formatter': JsFormatterIcon,
  'css-flexbox': FlexboxIcon,
  'gradient-generator': GradientIcon,
  'box-shadow': BoxShadowIcon,
  'text-case': TextCaseIcon,

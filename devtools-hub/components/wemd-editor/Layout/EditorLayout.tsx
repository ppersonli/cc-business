...
import { useMobileView } from '../../../lib/wemd/hooks/useMobileView'
...
export default function EditorLayout() {
  ...
  const { isMobile, mobileView, toggleMobileView, showEditor, showPreview } = useMobileView()
  ...
  return (
    ...
    >
      ...
      {isMobile && (
        ...
        >
          <button
            onClick={() => { if (mobileView !== 'editor') toggleMobileView() }}
            style={{
              flex: 1,
              padding: '10px 0',
              backgroundColor: mobileView === 'editor' ? (isDarkUI ? '#1e3a5f' : '#e0f2fe') : 'transparent',
              border: 'none',
              borderTop: mobileView === 'editor' ? `2px solid ${isDarkUI ? '#3b82f6' : '#07c160'}` : '2px solid transparent',
              color: mobileView === 'editor' ? (isDarkUI ? '#3b82f6' : '#07c160') : textMuted,
              fontSize: '13px',
          ...
          <button
            onClick={() => { if (mobileView !== 'preview') toggleMobileView() }}
            style={{
              flex: 1,
              padding: '10px 0',
              backgroundColor: mobileView === 'preview' ? (isDarkUI ? '#1e3a5f' : '#e0f2fe') : 'transparent',
              border: 'none',
              borderTop: mobileView === 'preview' ? `2px solid ${isDarkUI ? '#3b82f6' : '#07c160'}` : '2px solid transparent',
              color: mobileView === 'preview' ? (isDarkUI ? '#3b82f6' : '#07c160') : textMuted,
              fontSize: '13px',

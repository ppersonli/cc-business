...
declare module '#imports' {
  ...
  export { getXPathForNode, getElementByXPath, getTextOffsetInParent, normalizeUrl, truncateText, extractDomain, formatDate } from '../utils/dom-utils';
  export { exportAsJSON, exportAsHTML, exportForPage } from '../utils/export';
  export { HIGHLIGHT_COLORS, generateHighlightId, getHighlightColor, createHighlight, serializeHighlight, deserializeHighlight, getHighlightsForPage, removeHighlight, updateHighlightNote, HighlightColor, Highlight } from '../utils/highlight-utils';
  export { searchHighlights, searchByTag, getRecentHighlights, getUniquePages, groupHighlightsByPage } from '../utils/search';
  export { getAllHighlights, saveHighlights, addHighlightToStorage, removeHighlightFromStorage, getHighlightStats } from '../utils/storage';
}
